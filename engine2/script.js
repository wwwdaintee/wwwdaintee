...
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fly",prev:"",next:"",duration:33*100,delay:33*100,width:870,height:335,autoPlay:true,stopOnHover:true,loop:false,bullets:0,caption:true,captionEffect:"slide",controls:true,logo:"engine1/loading.gif",onBeforeStep:0,images:[{src:"",title:""},{src:"",title:""},{src:"",title:""},{src:"",title:""},{src:"",title:""},{src:"",title:""},{src:"",title:""}]});